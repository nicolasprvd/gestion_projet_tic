...
import com.app.projettic.web.rest.errors.EmailAlreadyUsedException;
import com.app.projettic.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
     ...
     *
     * @return the {@link List} with status {@code 200 (OK)} and with body all users.
     */
    @GetMapping("/users")
