...
export class ProjetComponent implements OnInit, OnDestroy {
  ...
  reprise(projet: IProjet): void {
    ...
    this.projetService.update(projet).subscribe(() => {
      this.toastrService.success(this.translateService.instant('global.toastr.reprise.projet.message'), this.translateService.instant('global.toastr.reprise.projet.title', {nom: projet.nom}));
      this.loadAll();
    },
      () => {
      this.isSaving = false;
